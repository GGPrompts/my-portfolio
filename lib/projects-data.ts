...
export const browserExtensions: Project[] = [
  {
    ...
    description: 'Chrome extension with Windows Terminal simplicity — bash terminals with customizable profiles in your browser sidebar. Plus 11 MCP tools that give Claude eyes and hands: screenshots, clicks, form fills, and JavaScript execution.',
    tagline: 'Give Claude Eyes, Hands, and Terminals',
    techStack: [
      'React',
      'TypeScript',
      'xterm.js',
    ...
    keyFeatures: [
      '11 Browser MCP tools for Claude (screenshot, click, fill, execute JS, etc.)',
      'Interactive /ttmcp command for menu-driven browser control',
      'Windows Terminal-style profiles (working directory + appearance)',
      'Hybrid persistence: Chrome storage for UI + tmux for processes',
      'Full xterm.js emulation with real-time WebSocket I/O',
      'Settings modal with General and Profiles tabs',
      'Right-click selected text to paste to terminal',
      'Keyboard shortcuts (Ctrl+Shift+9, Ctrl+Shift+C/V)',
      'Dark and light themes with 6 font options',
    ],
    highlights: [
      'MCP server lets Claude see and interact with your browser',
      '40% less code through Windows Terminal simplicity',
      'Hybrid state: Chrome storage + tmux = zero sync bugs',
      'Type /ttmcp in Claude Code for interactive tool menu',
    ],
    links: [
      { type: 'github', url: 'https://github.com/GGPrompts/TabzChrome' },
      { type: 'demo', url: '/projects/tabz-chrome', label: 'View Project' },
    ],
    featured: true,
    year: 2025,
  },
