...
export default function ResumeTimelinePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-zinc-950 text-foreground">
      {/* Animated background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              >
                <Avatar className="w-32 h-32 border-4 border-emerald-500/30">
                  ...
                  <AvatarFallback className="bg-emerald-500/20 text-3xl">MJ</AvatarFallback>
                </Avatar>
              </motion.div>
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div className="flex gap-2">
                    <Button size="icon" variant="ghost" className="hover:text-emerald-400">
            ...
            {achievements.map((achievement, i) => (
              ...
              >
                <Card className="glass border-white/10 p-4 h-full">
                  <achievement.icon className="w-8 h-8 text-emerald-400 mb-3" />
            ...
            >
              <Card className="glass border-white/10 p-8">
                ...
                <div className="relative">
                  {/* Timeline line */}
                  <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-emerald-500/50 via-cyan-500/50 to-emerald-500/50" />
                  ...
                  <div className="space-y-8">
                    {timelineData.map((item, i) => (
                      ...
                      >
                        {/* Timeline dot */}
                        <div className="relative z-10 flex items-center justify-center w-16 h-16 rounded-full glass border-2 border-emerald-500/50">
                          {item.type === 'work' ? (
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge variant="outline" className={cn(
                              "border-white/20",
                              item.type === 'work' ? 'text-emerald-400' : 'text-cyan-400'
                            )}>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {item.achievements.map((achievement, j) => (
                              <Badge key={j} variant="secondary" className="bg-emerald-500/10 text-emerald-300">
                                {achievement}
                              </Badge>
                            ))}
                          </div>
          ...
          <TabsContent value="skills">
            ...
            >
              <Card className="glass border-white/10 p-8">
                ...
                <div className="mt-8 p-6 glass rounded-lg border border-emerald-500/20">
          ...
          <TabsContent value="projects">
            ...
            >
              <Card className="glass border-white/10 p-8">
                      ...
                      <Card className="glass-dark border-white/10 p-6 h-full">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.tech.map((tech, j) => (
                            <Badge key={j} variant="outline" className="border-emerald-500/30 text-xs">
                              {tech}
                            </Badge>
                          ))}
                        </div>
                ...
                <div className="mt-6 p-4 glass rounded-lg border border-emerald-500/20 text-center">
                  <p className="text-muted-foreground mb-2">
                    Built <span className="text-emerald-400 font-bold">50+ projects</span> with Claude AI
                  </p>
        ...
        >
          <Card className="glass border-emerald-500/30 p-8 text-center border-glow">
            ...
            <div className="flex gap-4 justify-center">
              <Button size="lg" className="bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/30">
                <Calendar className="w-4 h-4 mr-2" />
                Schedule a Call
              </Button>
              <Button size="lg" variant="outline" className="border-emerald-500/30">
                <Mail className="w-4 h-4 mr-2" />
                Send Message
              </Button>
            </div>
