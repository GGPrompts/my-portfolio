...
export default function TUIClassicsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" className="font-mono">Game</Badge>
            </div>
          </div>
          ...
          <p className="text-xl text-foreground/80 mb-8 font-mono">
            Windows 95 Nostalgia Meets Modern Terminals
          </p>

          <p className="text-lg text-muted-foreground mb-8 max-w-4xl">
            TUI Games! - Classic games reimagined for the terminal
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <Button size="lg" className="font-mono border-glow" asChild>
              <a href="https://github.com/GGPrompts/TUIClassics" target="_blank" rel="noopener noreferrer">
            ...
            {[
              {
                ...
                title: "Beautiful, fully-interactive TUI versions of classic games",
                description: "Pixel-perfect rendering in your terminal"
              },
              {
                icon: <Sparkles className="h-5 w-5 text-primary" />,
                title: "Windows 95 school computer days nostalgia",
                description: "Relive the classics with modern polish"
              },
              {
                icon: <Trophy className="h-5 w-5 text-primary" />,
                title: "High score tracking and achievements",
                description: "Compete with yourself and track progress"
              },
              {
                icon: <Terminal className="h-5 w-5 text-primary" />,
                title: "Mouse and keyboard controls",
                description: "Play however you prefer"
              }
            ].map((highlight, index) => (
              <motion.div
                key={index}
        ...
        >
          ...
          <Card className="glass border-border/30 p-12 text-center">
            <Gamepad2 className="h-16 w-16 text-primary/50 mx-auto mb-4" />
            <p className="text-muted-foreground font-mono">Screenshots coming soon...</p>
            <p className="text-sm text-muted-foreground mt-2">
              6 classic games with beautiful TUI rendering
            </p>
          </Card>
        </motion.section>
        ...
        >
          ...
          <Card className="glass border-border/30 p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              See gameplay of Minesweeper, Solitaire, 2048, and more
            </p>
          </Card>
        </motion.section>
